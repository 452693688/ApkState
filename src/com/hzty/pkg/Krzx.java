...
public class Krzx {
	...
	private final String rootPath = root + "\\stateApk\\prepare_krzx\\";
	...
	// apk源
	private String apkPath = root
			+ "\\stateApk\\apk\\Hospital-ddys_krzx-release.apk";
	// apk解压路径
	...
	private String imageReplacePng = rootPath
			+ "unPak\\res\\drawable-ldpi\\push.png";
	// 启动图
	private String stateSourcePng = rootPath + "prepare\\welcome.png";
	private String stateReplacePng = rootPath
			+ "unPak\\res\\drawable-xhdpi\\welcome.png";
	...
	private String[] mValues = new String[] { "ddys_htzx" };

	private String[] authorities = new String[] { "downloads.cn.hztywl.ddysys" };
	private String[] authoritiesReplace = new String[] { "downloads.cn.hztywl.ddysys.krzx" };

	private String stringXml = rootPath + "unPak\\res\\values\\strings.xml";
	private String[] sNames = new String[] { "app_name", "app_type",
			"my_hospital", "my_office" };
	private String[] sValues = new String[] { "康乳在线", "ddys_krzx", "平台", "医院科室" };
	...
	public void replaceXML() {
		...
		// Provider
		ReplaceDataXML.replaceManifestProvider(manifest, authorities,
				authoritiesReplace);
		// 修改string.xml
	...
	private String keystore = root + "\\stateApk\\apk\\apps\\key";
